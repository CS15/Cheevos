...
public class FavoritesAdapter extends BaseAdapter {
    ...
    public FavoritesAdapter(Context context, ArrayList<GameDetails> data) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = viewInflater.inflate(R.layout.row_favorites, null);
            ...
            mViewHolder.mTvAchAmountCompleted = (TextView) view.findViewById(R.id.tv_game_ach_amount_completed);
        ...
        mViewHolder.mTvAchAmountCompleted.setText(String.format("%s achievements completed", mData.get(position).getAchievementsAmountCompleted()));
    ...
    class ViewHolder {
        ...
        TextView mTvAchAmountCompleted;
    }
}
